...
<h2 align="center"><font><strong> Student Data (Sorted by Login Time)</strong></font></h2>
...
String sql ="SELECT * FROM students ORDER BY LoginTime";
...
<form action="<%=request.getContextPath()%>/StudentPage" method="post">
                        ...
                        <select name="Options">
                            ...
                            <option selected>LoginTime</option>
