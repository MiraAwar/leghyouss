...
<h2 align="center"><font><strong> Student Data (Sorted by Logout Time)</strong></font></h2>
...
String sql ="SELECT * FROM students ORDER BY LogoutTime";
...
<form action="<%=request.getContextPath()%>/StudentPage" method="post">
                        ...
                        <select name="Options">
                            ...
                            <option selected>LogoutTime</option>
