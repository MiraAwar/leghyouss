...
<h2 align="center"><font><strong> Student Data (Sorted by Attendance Mark)</strong></font></h2>
...
String sql ="SELECT * FROM students ORDER BY AttendanceMark";
...
<form action="<%=request.getContextPath()%>/StudentPage" method="post">
                        ...
                        <select name="Options">
                            ...
                            <option>ID</option>
                            <option selected>AttendanceMark</option>
