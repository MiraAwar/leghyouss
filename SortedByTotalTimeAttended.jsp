...
<h2 align="center"><font><strong> Student Data (Sorted by Total Time Attended)</strong></font></h2>
...
String sql ="SELECT * FROM students ORDER BY TotalTimeAttended";
...
<form action="<%=request.getContextPath()%>/StudentPage" method="post">
                        ...
                        <select name="Options">
                            ...
                            <option selected>TotalTimeAttended</option>
                            <option>ID</option>
